 ...
 * @author PC-Dung
 */
public class QLXuphat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLXuphat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
